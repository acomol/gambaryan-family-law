...
/* Archivo + Archivo Black + Playfair Display — Google Fonts */
  ...
  return (
    <html lang="en" className="h-full antialiased">
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Archivo:wght@400;500;600;700;800;900&family=Archivo+Black&family=Archivo+Narrow:wght@400;500;600;700&family=Playfair+Display:ital,wght@0,400;0,500;0,600;0,700;1,400;1,500;1,600;1,700&display=swap"
          rel="stylesheet"
        />
      </head>
