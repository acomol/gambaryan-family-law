...
REPLACEMENTS: list[tuple[int, int, str, str]] = [
    ...
    (1, 1,
     '<p class="lead-form__error" hidden>Не удалось отправить заявку. Позвоните:',
     '<p class="lead-form__error" hidden>' + badge("6.9") + 'Не удалось отправить заявку. Позвоните:'),
    (1, 1,
     '<span class="field__label">Имя *</span>',
     '<span class="field__label">' + badge("6.10") + 'Имя *</span>'),
    (1, 1,
     '<span class="field__label">Телефон *</span>',
     '<span class="field__label">' + badge("6.11") + 'Телефон *</span>'),
    (1, 1,
     '<span class="field__label">Email</span>',
     '<span class="field__label">' + badge("6.12") + 'Email</span>'),
    (1, 1,
