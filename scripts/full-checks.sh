...
node --experimental-sqlite test/lead-qa.mjs | tail -1
node --experimental-sqlite test/cron-backup-qa.mjs | tail -1
node scripts/verify-lead-pipeline-remap.mjs | tail -1
...
node scripts/verify-lead-outbox.mjs
