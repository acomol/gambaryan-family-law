...
| `final-dev1` | Новый Hero без дубля телефона в шапке; на коротком mobile обе CTA входят в первый экран + Action Bar | https://final-dev1.gambarian-landing.pages.dev/ |
...
| Desktop Hero `final-dev1` | `1.2.0` | 2026-08-10 |
