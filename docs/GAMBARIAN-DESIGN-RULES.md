...
## Чего не делать — решения владельца

Каждый пункт — прямое указание владельца после того, как он это увидел. Список
передаётся исполнителю в любом дизайн-задании: без явных запретов модель возвращается
к своим привычным приёмам (правило `~/.claude/rules/opus-5-5-working-rules.md` §1.4).
Новое «не нравится» — дописывать сюда с датой.

| Не делать | Слова владельца | Дата |
|---|---|---|
| Толстые полосы, двойные рамки, золотое свечение вокруг блока | «в стиле всего ресурса и дизайнерски не грубо» | 2026-09-18 |
| Номера на карточках и плашках тем (01, 02…) | «Убрать номера» | 2026-09-17 |
| Подсказку «Далее» у карточки услуг | «Убрать» | 2026-09-17 |
| Менять высоту карточки услуг при переключении темы — двигается только текст | «Мы говорили о том что двигается только те[кст]…» | 2026-09-17 |
| Выносить кнопку записи из карточки услуг, внутреннюю рамку в карточке | «Верни золотую кромку и кнопку внутрь карточки» | 2026-09-17 |
| Одинокий центрированный адрес в пустой строке | «Это глупо» | 2026-09-16 |
| Знаки препинания в конце пунктов списка | «В конце предложения никаких знаков» | 2026-09-18 |
| Блоки в форме, отвлекающие от заявки (выбор канала связи) | «Этот блок не нужен, он отвлекает от конверсии» | 2026-09-16 |
| Менять фото первого экрана | постоянное правило | с 2026-09-16 |
