...
| Гейт трекинга | отдельно | ✅ автоматически / ❓ вручную | Карта `tracking/TRACKING-MAP.md`: GTM v3 не менялся, билд и прод после `c03e51c6` — PASS (`verify-tracking-map.mjs`). Открыто: 3 лишние основные конверсии в Ads (M3/M4; «Заявка» и «Calls from ads» остаются основными; ждут «да» владельца) и ручной «Этап 3» с телефона владельца |
