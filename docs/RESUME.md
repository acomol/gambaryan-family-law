...
| Аналитика/трекинг | план v2.0.0 готов (`docs/TRACKING-REQUIREMENTS.md`), но GA4 и GTM для `lp` **не существуют**: ни ADFIX, ни один из проверенных GA4-коннекторов доступа к ресурсу клиента не имеет, приглашений в почте нет. 10 решений владельца в §1 плана, включая — под каким адресом заводить GA4/GTM |
