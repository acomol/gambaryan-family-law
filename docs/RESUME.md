...
19 блокирующих — `docs/tasks/2026-09-06-final-dev4-questions.md`; без ответов
на первые девять (шрифты, фото, статус формулировок, ё/е, точки, свайп, карта,
скоуп публикации) реализация не начинается. Замеры шрифтов и фото —
