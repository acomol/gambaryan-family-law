...
`docs/CONTENT-OWNER-REVISIONS-2026-09-06.md`. Задание с открытыми вопросами и
приёмкой — `docs/tasks/2026-09-06-final-dev4-spec.md`. Замеры шрифтов и фото —
