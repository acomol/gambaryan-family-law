...
- Playfair Display + Onest и общий Action Bar `2.3.2`.
...
- в Hero остаётся один телефонный блок и утверждённый WhatsApp из `1.12`;
- общий Action Bar `2.3.2` не содержит неутверждённого WhatsApp prefill;
