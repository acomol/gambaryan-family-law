...
**Версия:** `FINAL-DEV4-STAGE-2 v1.0.1`
...
- [ ] Маркеры CLIENT-COPY-CONTRACT v1.6.0 | 2026-09-10 во всех источниках из раздела «Версии»; CONTENT-OWNER-EDITS v1.2.0 содержит все 15 owner-текстов дословно и 4 allowlist-строки
