...
- Исправить номер строки docstring runner (6, не 15) и добавить DEPLOY.md:112/188/189 в шаг 10 либо явно пометить их историей
- В final_dev4_contract.py задать TASK_PATH (как у final_dev3_contract) или явно написать «TASK_PATH нет» — этапы 4, 7, 8 ссылаются на «документ TASK_PATH из final_dev4_contract.py», которого карточка этапа 1 не определяет
- Явно зафиксировать в шаге 4/5, что dev3-список FINAL_DEV3_SCRIPT_REQUIRED_TOKENS (build-hero-variants.py:437, verify-client-previews.py:81) будет прогоняться и на адаптере dev4 через `key in {"dev3","dev4"}` — этап 4 обязан это расцепить (см. cross_stage)
- Все проверки, файлы и номера строк подтверждены по дереву a5de24d: verify-client-copy.py:38, verify-client-previews.py:61–76/:306/:375, qa-browser-matrix.py:62/:108–124/:809/:1033/:1115, deploy-previews.yml:3/:25, build-hero-variants.py:305/:315/:359/:406, verify-live-previews.py:4/:30/:117–124, client_copy_contract.py:3/:11–12, styles.css:657/:663/:1572/:1596, app.js:602/:615, review_numbered_contract.py:6–9, build-review-numbered.py:177–200, RESUME:32/:83–84/:119–131, CONTENT-APPROVED:25/:149/:152, SOURCE-MAP:40–42/:75/:78, FINAL-QA:55–56/:62/:65/:683, dark-fact-cards.md:80, CODEX-WORKING-MODEL:93; 12 текущих тестов → 13; 26 targets/24 unique при 12 alias
