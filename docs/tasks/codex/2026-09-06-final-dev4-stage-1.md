...
Проверка: grep -n '11' .github/workflows/deploy-previews.yml | grep -v 'v11\|2011' → пусто; grep -n 'одиннадцать' scripts/deploy-previews.sh docs/DEPLOY.md → пусто; grep -n 'из 11 \|все 11 \|11 вариантов' docs/DEPLOY.md → пусто
